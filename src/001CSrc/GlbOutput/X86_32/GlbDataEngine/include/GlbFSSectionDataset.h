...
class CGlbFSSectionDataset : public IGlbSectionDataset
{
protected:
	CGlbFSSectionDataset(void);
public:
	~CGlbFSSectionDataset(void);
	static CGlbFSSectionDataset* Open(JsonSectionDataset* dset,CGlbFSDataSource* ds);
	...
	IGlbObjectClass* GetCtrlPtClass();
	IGlbFeatureClass* GetNodeClass();
	IGlbFeatureClass* GetArcClass();
	IGlbFeatureClass* GetPolygonClass();
private:	
	CGlbString                    mpr_url;	
	...
	JsonSectionDataset*           mpr_jsondset;
public:
